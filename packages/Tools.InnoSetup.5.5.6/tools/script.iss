; Имя приложения
#define   Name       "WebSpider"
; Версия приложения
#define   Version    "0.0.1"
; Фирма-разработчик
#define   Publisher  "khapilins"
; Имя исполняемого модуля
#define   ExeName    "WebSpider.exe"

[Setup]
AppId={{2F82884B-2547-4A55-97BE-2D576BD1D5AC}
...
[Files]
; Исполняемый файл
Source: "..\..\..\WebSpider\bin\Release\WebSpider.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dotNetFx45_Full_setup.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall; Check: not IsRequiredDotNetDetected

; Прилагающиеся ресурсы
Source: "..\..\..\WebSpider\bin\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
